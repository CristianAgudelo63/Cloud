...
import Opcion from './header/modal';
import Opciones from './header/opciones';
	...
	return (
		<>
			...
			<Busqueda>
				...
				<Input className="input" type="text" placeholder="Buscar archivo o carpeta"></Input>
			</Busqueda>
